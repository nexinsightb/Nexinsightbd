...
import WhiteFeedbackModal from "./WhiteFeedbackModal";
import WhitePromoModal from "./WhitePromoModal";
import "./theme.css";

// ── SVG Icons (Official Full-Color Brand Logos) ─────────────────────
const InstagramIcon = () => (
  <svg width="28" height="28" viewBox="0 0 36 36" fill="none" aria-hidden="true">
    <defs>
      <linearGradient id="wt-ig-grad" x1="0%" y1="100%" x2="100%" y2="0%">
    ...
    <rect width="36" height="36" rx="10" fill="url(#wt-ig-grad)" />
    <path
...
interface WhiteThemePageProps {
  restaurant: Restaurant;
}

export default function WhiteThemePage({ restaurant }: WhiteThemePageProps) {
  ...
  return (
    <div className="wt-root">
      ...
      <div className="wt-page">
        ...
        {/* ── FEEDBACK SECTION ───────────────────────────────── */}
        <section className="wt-feedback" aria-labelledby="wtFeedbackHeading">
          <h1 className="wt-feedback-headline" id="wtFeedbackHeading">
            {restaurant.mainTitle || "How was your experience today?"}
          </h1>
          <div className="wt-btn-row">
            <button
              id="wtBtnSatisfied"
              className="wt-btn-satisfied"
              onClick={handleSatisfied}
              aria-label={restaurant.googleButtonText || "Satisfied with my visit"}
              type="button"
            >
            ...
            <button
              id="wtBtnNotSatisfied"
              className="wt-btn-not-satisfied"
              onClick={openFeedback}
              aria-label={restaurant.feedbackButtonText || "Not satisfied — leave private feedback"}
              type="button"
            >
              <span className="wt-btn-icon" aria-hidden="true">☹</span>
        ...
        {/* ── CAROUSEL ───────────────────────────────────────── */}
        <WhiteCarousel images={restaurant.carouselImages} />

        {/* ── PROMO BANNER ───────────────────────────────────── */}
        {restaurant.campaignEnabled !== false && (
          <div className="wt-promo">
            <div className="wt-promo-left">
              <p className="wt-promo-offer">
                {restaurant.promoTitle
                  ? restaurant.promoTitle.split("!")[0]
              ...
              <p className="wt-promo-sub">{restaurant.promoDescription}</p>
            </div>
            <div className="wt-promo-right">
              <div className="wt-icon-bubble">
                <GiftIcon />
              </div>
              <button
                id="wtBtnJoinPromo"
                className="wt-btn-join"
                onClick={openPromo}
                type="button"
              >
                {restaurant.promoCtaLabel || "Join the Birthday Club"}
              </button>
            </div>
          </div>
        )}
        ...
        {(restaurant.socialLinks?.instagram ||
          ...
          <div className="wt-social-pill-wrap">
            <div className="wt-social-pill">
              <span className="wt-social-pill-label">Follow Us</span>
              <div className="wt-social-pill-icons" aria-label="Social media links">
                {restaurant.socialLinks.instagram && (
                  <a
        ...
        {/* ── DIVIDER ────────────────────────────────────────── */}
        <div className="wt-hr" aria-hidden="true" />
        ...
        <footer className="wt-footer">
          <div className="wt-footer-inner">
            <div className="wt-footer-brand">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
                className="wt-footer-logo"
                src={restaurant.footerLogoUrl}
                alt={`${restaurant.name} footer logo`}
              />
            </div>

            <div className="wt-footer-divider" aria-hidden="true" />

            <address className="wt-footer-info" style={{ fontStyle: "normal" }}>
              <div className="wt-info-row">
                <span className="wt-info-icon" aria-hidden="true">📍</span>
          ...
          <div className="wt-tagline-wrap">
            <div className="wt-tagline-line" aria-hidden="true" />
            <span className="wt-tagline">{restaurant.tagline}</span>
            <div className="wt-tagline-line" aria-hidden="true" />
          </div>

          <p className="wt-heart">Contact NexInsight For Support</p>
        </footer>
      </div>
